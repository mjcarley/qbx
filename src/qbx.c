...
inline static void shape3(QBX_REAL s, QBX_REAL t, QBX_REAL L[])
...
static gint select_quadrature(QBX_REAL w, QBX_REAL tol,
...

{
  ...
  rp = w/64 ;
  select_quadrature(w, tol, nq, oq, 32, rp, rp, &N, &d) ;
